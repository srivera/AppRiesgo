...
public class GetStatusAsyncTask extends AsyncTask<String, Float, String> {


	private PrincipalActivity principalActivity;

	private final String NAMESPACE = "urn:WebServiceControllerwsdl";
	private final String METHOD = "getStatus";
	private String idIncidente;
	private Location ubicacion;


	public GetStatusAsyncTask(PrincipalActivity principalActivity, String idIncidente, Location ubicacion) {
		super();
	...
	protected void onPostExecute(String respuesta) {
		//principalActivity.verificarreportarEmergencia(respuesta, false);
	}
}
