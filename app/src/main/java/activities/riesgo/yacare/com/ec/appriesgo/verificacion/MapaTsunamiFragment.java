...
public class MapaTsunamiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_mapa_fragment_tsunami, container, false);
...
//
//
//                    ArrayList<Capa> capas = capaDataSource.getCapaByTipo(Constantes.CAPA_PUNTO_SEGURO, datosAplicacion.getRiesgoActual().getId());
//                    LatLng points = null;
//                         for (Capa capa : capas) {
//                             String[] coordenadas = capa.getCoordenadas().split(",");
